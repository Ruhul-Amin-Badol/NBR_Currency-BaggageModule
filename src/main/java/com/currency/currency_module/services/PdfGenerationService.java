...
//for baggage approve 
public byte[] generatePdf(List<?> rowData, List<String> includedFields, Double totalPaidAmount,Integer id,Principal principal) throws IOException {
